...
import os
from model.compat import split_dependency
from model.compat import lstm_ops
...
# (yaozhang): make sure we only save the canonical version of params and
...
def _cudnn_rnn(inputs,
  ...
  seed, seed2 = random_seed.get_seed(seed)
  # (jamesqin): switch default value to "1" on May 25th 2018, and get rid
  # of V1 ops.
...
class _CudnnRNN(object):
  ...
  # (jamesqin): support float16 CuDNN RNN
  def __init__(self,
               rnn_mode,
               num_layers,
               num_units,
